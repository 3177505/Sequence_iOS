...
echo "  • Optional Chromium kiosk if /etc/xdg/autostart/sequence-kiosk.desktop exists"
echo "  • Optional pygame dual-image if /etc/xdg/autostart/sequence-dual-image.desktop exists"
echo ""
